...
multilabel_model = pickle.load(open("sof_first_model.sav" , "rb"))
tfidf_vectorizer = pickle.load(open("tfidf_object.pickle", "rb"))
mlb = pickle.load(open("multilabel_binarizer.pickle", "rb"))
